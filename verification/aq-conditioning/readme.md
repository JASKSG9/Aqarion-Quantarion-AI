...
## Exact versus numerical conditioning checks

This folder contains the AQARION-CONDITION8NG verification package. Its purpose is to distinguish **exact finite linear-algebra facts** from tolerance-dependent numerical conclusions.

The package does not claim a proof of the Riemann Hypothesis, a Connes spectral realization, C4 clearance, publication readiness, or promotion eligibility.

```text
Evidence scope:
finite computational verification only
