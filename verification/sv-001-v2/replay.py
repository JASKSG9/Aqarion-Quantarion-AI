...
from oracle import enumerate_cases, expected_case_count, expected_zero_r_count
...
def main():
    ...
    receipt = {
        ...
        "governance": {"c4": "BLOCKED", "promotion": False,
                        "formal_status": "LEAN_OPEN", "public_certification": False},
        "domain": {"cases": len(cases), "zero_r": zero_r, "nonzero_r": len(cases) - zero_r},
        "verification": result,
        "binding": {
